...
public class UserNameRecognizer {
	 ...
	 * @version 1.02        2025-01-23  !!!Updated Finite State Machine implementation to match 
	 * 									new requirements, first character of User Name must be 
	 * 									alphabetic and now allows "-" and "_" between 
	 * 									alphanumerics.!!!
	 */
	...
	public static String checkForValidUserName(String input) {
		...
		while (running) {
			...
			case 0: 
				...
				// Transition [1] from State 0 Check for A-z, a-z
			...
			case 1: 
				...
				// Transition [1] from State 1 Check for A-Z, a-z, or 0-9
				if ((currentChar >= 'A' && currentChar <= 'Z' ) ||		
						(currentChar >= 'a' && currentChar <= 'z' ) ||	
				...
				// Transition [1] from State 1 to 2 Check for ., -, or _
				else if (currentChar == '.' || 
						 currentChar == '-' || 
						 currentChar == '_') {
					nextState = 2;
			...
			case 2: 
				...
				// Transition [1] from State 2 to State 1 Check for A-Z, a-z, or 0-9
				if ((currentChar >= 'A' && currentChar <= 'Z' ) ||		
						(currentChar >= 'a' && currentChar <= 'z' ) ||
						(currentChar >= '0' && currentChar <= '9' )) {	
					nextState = 1;
